...
{\color{blue}{\textbf{Authors: } 
Thanks for the insightful comments of the reviewer. Since the definition of MIMO systems usually include two possible explanations: the multi-antenna MIMO and the multi-user MIMO, we will elaborate our thoughts on both of these two explanations. 
...
Specifically, in the revised paper, we have addressed these issues in two parts:
