...
\blue{
    ...
    Furthermore, this asymptotic result of {\bf Theorem 1} is verified by our numerical simulations in {\bf Section VII}. Since this proof is strongly related to detection and estimation theory, we believe that this newly-added theoretical content would make this paper fit the broader scope of this journal. 
}
