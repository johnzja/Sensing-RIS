...
\subsection{Simultaneous Signaling and Interference Detection}
    ...
    \begin{figure}[htbp]
        ...
        \label{fig:scheme}
    \end{figure}
    Furthermore, if we allow the BS and UE to emit EM waves simultaneously, then the interference phenomenon will occur (see Fig.~\ref{fig:scheme}), and interference fringes \cite{louradour1993interference} will appear on the RIS. If we alter the phase at the UE, the interference fringes will change accordingly, allowing the power sensors on the RIS to obtain CSI. 
