    ...
    \begin{algorithm}[H] 
        ...
        \begin{algorithmic}[1]
            ...
            \FOR{$n=1,2,\cdots,N$}
                ...
                \STATE $\varphi_n \leftarrow$ estimate phase difference  $\varphi = \arg\left(f_{n}^{*}w'\right)-\arg\left(\bm g_{n}^{\rm T}\bm w\right)$ from $P_n(t)$, $\alpha$ and $\beta$. 
                \STATE $\psi_{n} \leftarrow$ estimate phase-shift ${\rm arg}(\bm g_{n}^{\rm T}\bm w)$ from geometric parameters of BS and RIS
