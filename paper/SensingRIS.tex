...
\subsubsection{ML method}
    ...
    \begin{equation}
        \frac{\partial \mathcal{L}(P[0:L] | \varphi)}{\partial \varphi} = \frac{2\alpha\beta}{\sigma_v^2}\sum_{l=0}^{L-1}\sin(\psi(t_l)+\varphi) \left[1 - \frac{ I_1\left(\frac{\sqrt{P[l] \lambda(t_l)}}{A\sigma_v^2/2}\right) }{ I_0\left( \frac{\sqrt{P[l] \lambda(t_l)}}{A\sigma_v^2/2} \right)} \frac{\sqrt{P[l]}}{\sqrt{\lambda(t_l)}}\right].
    \end{equation}
