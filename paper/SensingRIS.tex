...
\label{Proof of Theorem 3}
    ...
    \end{equation}
    Thus, $1/\gamma - \hat{g}(\gamma) \sim 1/2\,\mathcal O(1/\gamma)$, and the relative error $r$ of a single term in the CRLB expression is upper bounded by introducing a positive parameter $\epsilon$, which is
    \begin{equation}
        \begin{aligned}
