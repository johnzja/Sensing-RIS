...
\subsubsection{CRLB}
    In fact, taking the negative expectation of \eqref{Second Derivative Likelihood} yields the reciprocal CRLB of the estimators for $\hat{\varphi}$. Following are some analytically evaluated useful integrals.
    \begin{equation}
        \begin{aligned}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    The trickiest expectation is evaluated approximately by using the asymptotic expansion $x(1-R^2(\sqrt{x}/2)) \approx \sqrt{x}/2$:
    \begin{equation}
        \begin{aligned}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    where $(x)^{+}$ denotes $x \mathbbm{1}_{\{x \ge 0\}}$.
